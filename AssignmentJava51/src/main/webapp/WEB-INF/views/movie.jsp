...
<section class="product-page spad">
	<div class="container">
		...
		<div class="product__pagination text-center">
			<a href="all-video?pageNum=1"><i class="fa fa-angle-double-left"></i></a>
			<c:forEach begin="1" end="${totalPage}" varStatus="i">
				<a href="all-video?pageNum=${i.index}" class="current-page">${i.index}</a>
			</c:forEach>
			<a href="all-video?pageNum=${totalPage}"><i
